...
\textbf{A}MPLIFIER with \textbf{C}APACITORS) lowpass and highpass
...
IVg : 0
    ...
    \textbf{Step 3.2.} Use node voltages to calculate capacitors bandwidths.
...
Figure 8. The sum of all voltages at the input should be obtained at the
...
\PY{n}{LC\PYZus{}schematic} \PY{o}{=} \PY{p}{[}
    ...
    \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{V}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{E1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}
\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{EE\PYZus{}schematic} \PY{o}{=} \PY{p}{[}
    \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{V}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{E1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}
    \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{V}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{E2}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}
\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
higher gain, are shown in Figure 13.
    ...
    \begin{center}    
    \includegraphics[scale = 0.7]{Figure13.PNG}\\
...
Figure 14.
 ...
 \begin{center}    
    \includegraphics[scale = 0.7]{Figure14.PNG}\\
...
circuit
     ...
     \begin{center}    
    \includegraphics[scale = 0.7]{Figure15.PNG}\\
...
circuit
     ...
     \begin{center}    
    \includegraphics[scale = 0.7]{Figure16.PNG}\\
...
circuit
     ...
     \begin{center}    
    \includegraphics[scale = 0.7]{Figure17.PNG}\\
...
circuit
    ...
    \begin{center}
    \includegraphics[scale = 0.7]{Figure18.PNG}\\
...
open circuit
    ...
    \begin{center}
    \includegraphics[scale = 0.7]{Figure19.PNG}\\
...
closed circuit
    ...
    \begin{center}
    \includegraphics[scale = 0.7]{Figure20.PNG}\\
...
open circuit
    ...
    \begin{center}
    \includegraphics[scale = 0.7]{Figure21.PNG}\\
...
closed circuit
    ...
    \begin{center}
    \includegraphics[scale = 0.7]{Figure22.PNG}\\
